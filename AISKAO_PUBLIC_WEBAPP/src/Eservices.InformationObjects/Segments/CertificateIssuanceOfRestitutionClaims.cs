...
{
    [MetadataType(typeof(CertificateIssuanceOfRestitutionClaimsMD))]
    public partial class CertificateIssuanceOfRestitutionClaims : IInformationObject, IPropertyElectronicApplicationDocument
    {
        ...
        [SelfValidation]
        public void CertificateIssuanceOfRestitutionClaimsValidation(Microsoft.Practices.EnterpriseLibrary.Validation.ValidationResults results)
        {
            string msg;
