...
{
    [MetadataType(typeof(AmendmentOfRealEstateTaxAssesmentMD))]
    public partial class AmendmentOfRealEstateTaxAssesment : IInformationObject, IPropertyElectronicApplicationDocument
    {
        ...
        [SelfValidation]
        public void AmendmentOfRealEstateTaxAssesmentValidation(Microsoft.Practices.EnterpriseLibrary.Validation.ValidationResults results)
        {
            string msg;
