...
{
    [MetadataType(typeof(EstablishingTheRightToUpgradeAndAdditionMD))]
    public partial class EstablishingTheRightToUpgradeAndAddition : IInformationObject, IPropertyElectronicApplicationDocument
    {
        ...
        [SelfValidation]
        public void EstablishingTheRightToUpgradeAndAdditionValidation(Microsoft.Practices.EnterpriseLibrary.Validation.ValidationResults results)
        {
            string msg;
