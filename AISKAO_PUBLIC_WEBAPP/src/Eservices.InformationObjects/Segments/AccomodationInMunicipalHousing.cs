...
{
    [MetadataType(typeof(AccomodationInMunicipalHousingMD))]
    public partial class AccomodationInMunicipalHousing : IInformationObject, IElectronicApplicationDocument
    {
        ...
        [SelfValidation]
        public void AccomodationInMunicipalHousingValidation(Microsoft.Practices.EnterpriseLibrary.Validation.ValidationResults results)
        {
            string msg;
