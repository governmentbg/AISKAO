...
{
    [MetadataType(typeof(InquiryOnTransactionsWithMunicipalPropertiesMD))]
    public partial class InquiryOnTransactionsWithMunicipalProperties : IInformationObject, IPropertyElectronicApplicationDocument
    {
