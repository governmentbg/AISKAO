...
{
    [MetadataType(typeof(CertificateIssuanceOfWithdrawnOrRetrievedMunicipalPropertyMD))]
    public partial class CertificateIssuanceOfWithdrawnOrRetrievedMunicipalProperty : IInformationObject, IPropertyElectronicApplicationDocument
    {
        ...
        [SelfValidation]
        public void CertificateIssuanceOfWithdrawnOrRetrievedMunicipalPropertyValidation(Microsoft.Practices.EnterpriseLibrary.Validation.ValidationResults results)
        {
            string msg;
