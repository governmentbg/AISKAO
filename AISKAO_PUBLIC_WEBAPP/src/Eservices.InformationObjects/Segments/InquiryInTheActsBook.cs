...
{
    [MetadataType(typeof(InquiryInTheActsBookMD))]
    public partial class InquiryInTheActsBook : IInformationObject, IPropertyElectronicApplicationDocument
    {
        ...
        [SelfValidation]
        public void InquiryInTheActsBookValidation(Microsoft.Practices.EnterpriseLibrary.Validation.ValidationResults results)
        {
            string msg;
