...
{
    [MetadataType(typeof(CertificateIssuanceForTheSaleOfCoownedPropertyMD))]
    public partial class CertificateIssuanceForTheSaleOfCoownedProperty : IInformationObject, IPropertyElectronicApplicationDocument
    {
        ...
        [SelfValidation]
        public void CertificateIssuanceForTheSaleOfCoownedPropertyValidation(Microsoft.Practices.EnterpriseLibrary.Validation.ValidationResults results)
        {
            string msg;
