...
{
    [MetadataType(typeof(CertificateIssuanceForRealEstateOwnershipMD))]
    public partial class CertificateIssuanceForRealEstateOwnership : IInformationObject, IPropertyElectronicApplicationDocument
    {
        ...
        [SelfValidation]
        public void CertificateIssuanceForRealEstateOwnershipValidation(Microsoft.Practices.EnterpriseLibrary.Validation.ValidationResults results)
        {
            string msg;
