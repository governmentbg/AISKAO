...
{
    [MetadataType(typeof(DocumentProcessingAndTerminationOfJointOwnershipOfPropertyMD))]
    public partial class DocumentProcessingAndTerminationOfJointOwnershipOfProperty : IInformationObject, IPropertyElectronicApplicationDocument
    {
        ...
        [SelfValidation]
        public void DocumentProcessingAndTerminationOfJointOwnershipOfPropertyValidation(Microsoft.Practices.EnterpriseLibrary.Validation.ValidationResults results)
        {
            string msg;
