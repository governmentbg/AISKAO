...
{
    [MetadataType(typeof(MunicipalPropertyEvaluationApplicationMD))]
    public partial class MunicipalPropertyEvaluationApplication : IInformationObject, IPropertyElectronicApplicationDocument
    {
        ...
        [SelfValidation]
        public void MunicipalPropertyEvaluationApplicationValidation(Microsoft.Practices.EnterpriseLibrary.Validation.ValidationResults results)
        {
            string msg;
