...
{
    [MetadataType(typeof(RemovalFromTheActBookOfPropertyAcquiredThroughALegalTransactionMD))]
    public partial class RemovalFromTheActBookOfPropertyAcquiredThroughALegalTransaction : IInformationObject, IPropertyElectronicApplicationDocument
    {
        ...
        [SelfValidation]
        public void RemovalFromTheActBookOfPropertyAcquiredThroughALegalTransactionValidation(Microsoft.Practices.EnterpriseLibrary.Validation.ValidationResults results)
        {
            string msg;
