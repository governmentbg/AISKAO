...
{
    [MetadataType(typeof(RemovalFromTheActBookOfPropertiesRestoredByDecisionOfTheLandCommissionMD))]
    public partial class RemovalFromTheActBookOfPropertiesRestoredByDecisionOfTheLandCommission : IInformationObject, IPropertyElectronicApplicationDocument
    {
        ...
        [SelfValidation]
        public void RemovalFromTheActBookOfPropertiesRestoredByDecisionOfTheLandCommissionValidation(Microsoft.Practices.EnterpriseLibrary.Validation.ValidationResults results)
        {
            string msg;
