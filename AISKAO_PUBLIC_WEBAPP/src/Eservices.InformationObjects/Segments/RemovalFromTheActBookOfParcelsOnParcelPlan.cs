...
{
    [MetadataType(typeof(RemovalFromTheActBookOfParcelsOnParcelPlanMD))]
    public partial class RemovalFromTheActBookOfParcelsOnParcelPlan : IInformationObject, IPropertyElectronicApplicationDocument
    {
        ...
        [SelfValidation]
        public void RemovalFromTheActBookOfParcelsOnParcelPlanValidation(Microsoft.Practices.EnterpriseLibrary.Validation.ValidationResults results)
        {
            string msg;
