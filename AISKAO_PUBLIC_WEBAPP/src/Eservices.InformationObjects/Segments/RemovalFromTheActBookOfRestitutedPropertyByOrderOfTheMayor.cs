...
{
    [MetadataType(typeof(RemovalFromTheActBookOfRestitutedPropertyByOrderOfTheMayorMD))]
    public partial class RemovalFromTheActBookOfRestitutedPropertyByOrderOfTheMayor : IInformationObject, IPropertyElectronicApplicationDocument
    {
        ...
        [SelfValidation]
        public void RemovalFromTheActBookOfRestitutedPropertyByOrderOfTheMayorValidation(Microsoft.Practices.EnterpriseLibrary.Validation.ValidationResults results)
        {
            string msg;
