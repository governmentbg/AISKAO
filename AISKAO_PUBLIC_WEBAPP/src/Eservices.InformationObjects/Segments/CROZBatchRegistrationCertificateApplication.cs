...
{
    public partial class CROZBatchRegistrationCertificateApplication : IInformationObject
    {
        /// <summary>
        ...
        public bool ShouldSerializeAttachedDocuments()
        {
            return !(this.AttachedDocuments == null
                || this.AttachedDocuments.Count <= 0);
        }
