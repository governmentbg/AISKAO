...
{
    public partial class CROZConsignmentEntryEntityCertificate : IInformationObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <returns>Истина, ако има дефинирани елементи в списъка</returns>
        public bool ShouldSerializeCROZConsignmentRegistrationEntryDatas()
        {
            return !(this.CROZConsignmentRegistrationEntryDatas == null
                || this.CROZConsignmentRegistrationEntryDatas.Count <= 0);
        }
