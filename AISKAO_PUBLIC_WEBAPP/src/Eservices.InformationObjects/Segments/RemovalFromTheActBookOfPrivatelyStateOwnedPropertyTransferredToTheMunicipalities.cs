...
{
    [MetadataType(typeof(RemovalFromTheActBookOfPrivatelyStateOwnedPropertyTransferredToTheMunicipalitiesMD))]
    public partial class RemovalFromTheActBookOfPrivatelyStateOwnedPropertyTransferredToTheMunicipalities : IInformationObject, IPropertyElectronicApplicationDocument
    {
        ...
        [SelfValidation]
        public void RemovalFromTheActBookOfPrivatelyStateOwnedPropertyTransferredToTheMunicipalitiesValidation(Microsoft.Practices.EnterpriseLibrary.Validation.ValidationResults results)
        {
            string msg;
