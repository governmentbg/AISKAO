...
{
    [MetadataType(typeof(IssueOfActsOfStateOwnedParcelsIncludedInTheParcelPlansOfFarmyardsMD))]
    public partial class IssueOfActsOfStateOwnedParcelsIncludedInTheParcelPlansOfFarmyards : IInformationObject, IPropertyElectronicApplicationDocument
    {
        ...
        [SelfValidation]
        public void IssueOfActsOfStateOwnedParcelsIncludedInTheParcelPlansOfFarmyardsValidation(Microsoft.Practices.EnterpriseLibrary.Validation.ValidationResults results)
        {
            string msg;
