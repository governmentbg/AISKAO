...
{
    [MetadataType(typeof(CertificateIssuanceOnAlienationOfPropertyMD))]
    public partial class CertificateIssuanceOnAlienationOfProperty : IInformationObject, IPropertyElectronicApplicationDocument
    {
        ...
        [SelfValidation]
        public void CertificateIssuanceOnAlienationOfPropertyValidation(Microsoft.Practices.EnterpriseLibrary.Validation.ValidationResults results)
        {
            string msg;
