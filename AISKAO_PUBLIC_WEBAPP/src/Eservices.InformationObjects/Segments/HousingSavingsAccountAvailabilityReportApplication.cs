...
{
    [MetadataType(typeof(HousingSavingsAccountAvailabilityReportApplicationMD))]
    public partial class HousingSavingsAccountAvailabilityReportApplication : IInformationObject
    {
        ...
        [SelfValidation]
        public void HousingSavingsApplicationValidation(Microsoft.Practices.EnterpriseLibrary.Validation.ValidationResults results)
        {
            string msg;
