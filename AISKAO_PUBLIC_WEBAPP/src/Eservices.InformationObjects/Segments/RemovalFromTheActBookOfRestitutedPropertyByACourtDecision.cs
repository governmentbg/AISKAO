...
{
    [MetadataType(typeof(RemovalFromTheActBookOfRestitutedPropertyByACourtDecisionMD))]
    public partial class RemovalFromTheActBookOfRestitutedPropertyByACourtDecision : IInformationObject, IPropertyElectronicApplicationDocument
    {
        ...
        [SelfValidation]
        public void RemovalFromTheActBookOfRestitutedPropertyByACourtDecisionValidation(Microsoft.Practices.EnterpriseLibrary.Validation.ValidationResults results)
        {
            string msg;
