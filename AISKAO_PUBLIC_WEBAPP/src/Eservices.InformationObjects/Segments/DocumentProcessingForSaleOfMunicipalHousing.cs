...
{
    [MetadataType(typeof(DocumentProcessingForSaleOfMunicipalHousingMD))]
    public partial class DocumentProcessingForSaleOfMunicipalHousing : IInformationObject, IPropertyElectronicApplicationDocument
    {
        ...
        [SelfValidation]
        public void DocumentProcessingForSaleOfMunicipalHousingValidation(Microsoft.Practices.EnterpriseLibrary.Validation.ValidationResults results)
        {
            string msg;
