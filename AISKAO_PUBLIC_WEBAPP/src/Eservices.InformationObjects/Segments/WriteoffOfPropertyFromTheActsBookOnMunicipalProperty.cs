...
{
    [MetadataType(typeof(WriteoffOfPropertyFromTheActsBookOnMunicipalPropertyMD))]
    public partial class WriteoffOfPropertyFromTheActsBookOnMunicipalProperty : IInformationObject, IPropertyElectronicApplicationDocument
    {
        ...
        [SelfValidation]
        public void WriteoffOfPropertyFromTheActsBookOnMunicipalPropertyValidation(Microsoft.Practices.EnterpriseLibrary.Validation.ValidationResults results)
        {
            string msg;
