...
{
    [MetadataType(typeof(OrderingTheConfiscationOfStatePropertyWhichIsPossessedOrHoldWithoutJustificationMD))]
    public partial class OrderingTheConfiscationOfStatePropertyWhichIsPossessedOrHoldWithoutJustification : IInformationObject, IPropertyElectronicApplicationDocument
    {
        ...
        [SelfValidation]
        public void OrderingTheConfiscationOfStatePropertyWhichIsPossessedOrHoldWithoutJustificationValidation(Microsoft.Practices.EnterpriseLibrary.Validation.ValidationResults results)
        {
            string msg;
