...
{
    [MetadataType(typeof(CertificateIssuanceOfAvailabilityOfRestitutionClaimsForMunicipalPropertyMD))]
    public partial class CertificateIssuanceOfAvailabilityOfRestitutionClaimsForMunicipalProperty : IInformationObject, IPropertyElectronicApplicationDocument
    {
        ...
        [SelfValidation]
        public void CertificateIssuanceOfAvailabilityOfRestitutionClaimsForMunicipalPropertyValidation(Microsoft.Practices.EnterpriseLibrary.Validation.ValidationResults results)
        {
            string msg;
