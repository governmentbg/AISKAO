...
{
    [MetadataType(typeof(HousingSavingAccountCertificateMD))]
    public partial class HousingSavingAccountCertificate : IInformationObject, IElectronicApplicationDocument
    {
        ...
        [SelfValidation]
        public void HousingSavingAccountCertificateValidation(Microsoft.Practices.EnterpriseLibrary.Validation.ValidationResults results)
        {
            string msg;
