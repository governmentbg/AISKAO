...
{
    [MetadataType(typeof(CertificateIssuanceOfFoundHousingNeedsMD))]
    public partial class CertificateIssuanceOfFoundHousingNeeds : IInformationObject, IElectronicApplicationDocument
    {
        ...
        [SelfValidation]
        public void CertificateIssuanceOfFoundHousingNeedsValidation(Microsoft.Practices.EnterpriseLibrary.Validation.ValidationResults results)
        {
            string msg;
