...
{
    [MetadataType(typeof(ReturnOfConfiscatedPropertyOrCompensationMD))]
    public partial class ReturnOfConfiscatedPropertyOrCompensation : IInformationObject, IPropertyElectronicApplicationDocument
    {
        ...
        [SelfValidation]
        public void ReturnOfConfiscatedPropertyOrCompensationValidation(Microsoft.Practices.EnterpriseLibrary.Validation.ValidationResults results)
        {
            string msg;
