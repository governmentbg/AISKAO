...
{
    [MetadataType(typeof(IssuanceOfDecisionsOnCompensationUnderTheActToCompensateOwnersOfNationalizedPropertiesMD))]
    public partial class IssuanceOfDecisionsOnCompensationUnderTheActToCompensateOwnersOfNationalizedProperties : IInformationObject, IPropertyElectronicApplicationDocument
    {
        ...
        [SelfValidation]
        public void IssuanceOfDecisionsOnCompensationUnderTheActToCompensateOwnersOfNationalizedPropertiesValidation(Microsoft.Practices.EnterpriseLibrary.Validation.ValidationResults results)
        {
            string msg;
