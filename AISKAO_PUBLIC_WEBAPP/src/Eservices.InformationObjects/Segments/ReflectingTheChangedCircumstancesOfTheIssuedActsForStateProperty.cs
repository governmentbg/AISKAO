...
{
    [MetadataType(typeof(ReflectingTheChangedCircumstancesOfTheIssuedActsForStatePropertyMD))]
    public partial class ReflectingTheChangedCircumstancesOfTheIssuedActsForStateProperty : IInformationObject, IPropertyElectronicApplicationDocument
    {
        ...
        [SelfValidation]
        public void ReflectingTheChangedCircumstancesOfTheIssuedActsForStatePropertyValidation(Microsoft.Practices.EnterpriseLibrary.Validation.ValidationResults results)
        {
            string msg;
