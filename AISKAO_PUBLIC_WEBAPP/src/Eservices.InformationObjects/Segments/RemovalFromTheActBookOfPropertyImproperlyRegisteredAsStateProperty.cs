...
{
    [MetadataType(typeof(RemovalFromTheActBookOfPropertyImproperlyRegisteredAsStatePropertyMD))]
    public partial class RemovalFromTheActBookOfPropertyImproperlyRegisteredAsStateProperty : IInformationObject, IPropertyElectronicApplicationDocument
    {
        ...
        [SelfValidation]
        public void RemovalFromTheActBookOfPropertyImproperlyRegisteredAsStatePropertyValidation(Microsoft.Practices.EnterpriseLibrary.Validation.ValidationResults results)
        {
            string msg;
