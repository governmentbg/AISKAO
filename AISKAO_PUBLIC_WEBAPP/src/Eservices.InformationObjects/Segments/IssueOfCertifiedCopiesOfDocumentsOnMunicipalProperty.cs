...
{
    [MetadataType(typeof(IssueOfCertifiedCopiesOfDocumentsOnMunicipalPropertyMD))]
    public partial class IssueOfCertifiedCopiesOfDocumentsOnMunicipalProperty : IInformationObject, IPropertyElectronicApplicationDocument
    {
        ...
        [SelfValidation]
        public void IssueOfCertifiedCopiesOfDocumentsOnMunicipalPropertyValidation(Microsoft.Practices.EnterpriseLibrary.Validation.ValidationResults results)
        {
            string msg;
