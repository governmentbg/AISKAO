...
{
    [MetadataType(typeof(RemovalFromTheActBookOfPropertyForTheBenefitOfCompaniesMD))]
    public partial class RemovalFromTheActBookOfPropertyForTheBenefitOfCompanies : IInformationObject, IPropertyElectronicApplicationDocument
    {
        ...
        public void RemovalFromTheActBookOfPropertyForTheBenefitOfCompaniesValidation(Microsoft.Practices.EnterpriseLibrary.Validation.ValidationResults results)
        {
            string msg;
