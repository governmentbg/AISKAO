...
{
    [MetadataType(typeof(DocumentProcessingForCompensationOfHousingSavingAccountMD))]
    public partial class DocumentProcessingForCompensationOfHousingSavingAccount : IInformationObject, IElectronicApplicationDocument
    {
        ...
        [SelfValidation]
        public void DocumentProcessingForCompensationOfHousingSavingAccountValidation(Microsoft.Practices.EnterpriseLibrary.Validation.ValidationResults results)
        {
            string msg;
