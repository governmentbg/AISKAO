...
{
    [MetadataType(typeof(CertificateIssuanceOfOwnershipMD))]
    public partial class CertificateIssuanceOfOwnership : IInformationObject, IPropertyElectronicApplicationDocument
    {
        ...
        [SelfValidation]
        public void CertificateIssuanceOfOwnershipValidation(Microsoft.Practices.EnterpriseLibrary.Validation.ValidationResults results)
        {
            string msg;
