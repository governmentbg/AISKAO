...
{
    [MetadataType(typeof(CircumstantialVerificationForRecognizingTheRightOfOwnershipMD))]
    public partial class CircumstantialVerificationForRecognizingTheRightOfOwnership : IInformationObject, IPropertyElectronicApplicationDocument
    {
        ...
        [SelfValidation]
        public void CircumstantialVerificationForRecognizingTheRightOfOwnershipValidation(Microsoft.Practices.EnterpriseLibrary.Validation.ValidationResults results)
        {
            string msg;
