...
{
    [MetadataType(typeof(RemovalFromTheActBookOfPropertyPurchasedUnderContractByTheGovernorMD))]
    public partial class RemovalFromTheActBookOfPropertyPurchasedUnderContractByTheGovernor : IInformationObject, IPropertyElectronicApplicationDocument
    {
        ...
        [SelfValidation]
        public void RemovalFromTheActBookOfPropertyPurchasedUnderContractByTheGovernorValidation(Microsoft.Practices.EnterpriseLibrary.Validation.ValidationResults results)
        {
            string msg;
