...
{
    [MetadataType(typeof(InqueryInRegistryAndBooksAboutRealEstatePublicAndPrivateStatePropertyMD))]
    public partial class InqueryInRegistryAndBooksAboutRealEstatePublicAndPrivateStateProperty : IInformationObject, IPropertyElectronicApplicationDocument
    {
        ...
        [SelfValidation]
        public void InqueryInRegistryAndBooksAboutRealEstatePublicAndPrivateStatePropertyValidation(Microsoft.Practices.EnterpriseLibrary.Validation.ValidationResults results)
        {
            string msg;
