...
{
    [MetadataType(typeof(InquiryOnTheDistributionOfSharesOfTheCommonPartsOfBuildingsMD))]
    public partial class InquiryOnTheDistributionOfSharesOfTheCommonPartsOfBuildings : IInformationObject, IPropertyElectronicApplicationDocument
    {
        ...
        [SelfValidation]
        public void InquiryOnTheDistributionOfSharesOfTheCommonPartsOfBuildingsValidation(Microsoft.Practices.EnterpriseLibrary.Validation.ValidationResults results)
        {
            string msg;
