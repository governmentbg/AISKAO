...
{
    [MetadataType(typeof(IssueOfActsOnPublicStatePropertyToAgenciesMinistriesMD))]
    public partial class IssueOfActsOnPublicStatePropertyToAgenciesMinistries : IInformationObject, IPropertyElectronicApplicationDocument
    {
        ...
        [SelfValidation]
        public void IssueOfActsOnPublicStatePropertyToAgenciesMinistriesValidation(Microsoft.Practices.EnterpriseLibrary.Validation.ValidationResults results)
        {
            string msg;
