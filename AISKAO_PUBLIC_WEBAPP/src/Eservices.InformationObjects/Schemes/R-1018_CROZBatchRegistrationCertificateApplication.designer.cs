...
namespace TechnoLogica.Eservices.InformationObjects {
    ...
    [System.Xml.Serialization.XmlTypeAttribute(Namespace="http://ereg.egov.bg/segment/R-1018")]
    [System.Xml.Serialization.XmlRootAttribute(Namespace="http://ereg.egov.bg/segment/R-1018", IsNullable=false)]
    public partial class CROZBatchRegistrationCertificateApplication : InformationObject<CROZBatchRegistrationCertificateApplication> {
        ...
        private CROZResultInformationPeriodData cROZResultInformationPeriodDataField;
        ...
        /// <summary>
        /// CROZBatchRegistrationCertificateApplication class constructor
        /// </summary>
        public CROZBatchRegistrationCertificateApplication() {
            ...
            this.cROZResultInformationPeriodDataField = new CROZResultInformationPeriodData();
        ...
        public CROZResultInformationPeriodData CROZResultInformationPeriodData {
            get {
                return this.cROZResultInformationPeriodDataField;
            }
            set {
                if ((this.cROZResultInformationPeriodDataField != null)) {
                    if ((cROZResultInformationPeriodDataField.Equals(value) != true)) {
                        this.cROZResultInformationPeriodDataField = value;
                        this.OnPropertyChanged("CROZResultInformationPeriodData");
                    }
                }
                else {
                    this.cROZResultInformationPeriodDataField = value;
