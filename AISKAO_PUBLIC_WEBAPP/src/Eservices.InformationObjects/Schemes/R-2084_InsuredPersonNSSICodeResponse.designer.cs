...
namespace TechnoLogica.Eservices.InformationObjects {
    ...
    [System.Xml.Serialization.XmlTypeAttribute(Namespace="http://ereg.egov.bg/segment/R-2084")]
    [System.Xml.Serialization.XmlRootAttribute(Namespace="http://ereg.egov.bg/segment/R-2084", IsNullable=false)]
    public partial class InsuredPersonNSSICodeResponse : InformationObject<InsuredPersonNSSICodeResponse> {
        ...
        private string insuredPersonNNSICodeField;
        
        private InsuredPersonNSSICodeResponseOfficial officialField;
        
        private XMLDigitalSignature xMLDigitalSignatureField;
        
        /// <summary>
        /// InsuredPersonNSSICodeResponse class constructor
        /// </summary>
        public InsuredPersonNSSICodeResponse() {
            this.xMLDigitalSignatureField = new XMLDigitalSignature();
            this.officialField = new InsuredPersonNSSICodeResponseOfficial();
        ...
        public string InsuredPersonNNSICode {
            get {
                return this.insuredPersonNNSICodeField;
            }
            set {
                if ((this.insuredPersonNNSICodeField != null)) {
                    if ((insuredPersonNNSICodeField.Equals(value) != true)) {
                        this.insuredPersonNNSICodeField = value;
                        this.OnPropertyChanged("InsuredPersonNNSICode");
                    }
                }
                else {
                    this.insuredPersonNNSICodeField = value;
        ...
        public InsuredPersonNSSICodeResponseOfficial Official {
            get {
    ...
    [System.SerializableAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true, Namespace="http://ereg.egov.bg/segment/R-2084")]
    public partial class InsuredPersonNSSICodeResponseOfficial : InformationObject<InsuredPersonNSSICodeResponseOfficial> {
