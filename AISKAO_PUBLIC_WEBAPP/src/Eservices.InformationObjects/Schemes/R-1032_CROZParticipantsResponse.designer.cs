...
namespace TechnoLogica.Eservices.InformationObjects {
    ...
    [System.Xml.Serialization.XmlTypeAttribute(Namespace="http://ereg.egov.bg/segment/R-1032")]
    [System.Xml.Serialization.XmlRootAttribute(Namespace="http://ereg.egov.bg/segment/R-1032", IsNullable=false)]
    public partial class CROZParticipantsResponse : InformationObject<CROZParticipantsResponse> {
        ...
        private string cROZParticipantServiceIdentificationCodeField;
        
        private List<CROZBatchIdentifyingData> cROZBatchIdentifyingDatasField;
        
        private CROZParticipantsResponseOfficial officialField;
        
        private XMLDigitalSignature xMLDigitalSignatureField;
        
        /// <summary>
        /// CROZParticipantsResponse class constructor
        /// </summary>
        public CROZParticipantsResponse() {
            this.xMLDigitalSignatureField = new XMLDigitalSignature();
            this.officialField = new CROZParticipantsResponseOfficial();
            this.cROZBatchIdentifyingDatasField = new List<CROZBatchIdentifyingData>();
        ...
        public string CROZParticipantServiceIdentificationCode {
            get {
                return this.cROZParticipantServiceIdentificationCodeField;
            }
            set {
                if ((this.cROZParticipantServiceIdentificationCodeField != null)) {
                    if ((cROZParticipantServiceIdentificationCodeField.Equals(value) != true)) {
                        this.cROZParticipantServiceIdentificationCodeField = value;
                        this.OnPropertyChanged("CROZParticipantServiceIdentificationCode");
                    }
                }
                else {
                    this.cROZParticipantServiceIdentificationCodeField = value;
        ...
        public List<CROZBatchIdentifyingData> CROZBatchIdentifyingDatas {
            get {
                return this.cROZBatchIdentifyingDatasField;
            }
            set {
                if ((this.cROZBatchIdentifyingDatasField != null)) {
                    if ((cROZBatchIdentifyingDatasField.Equals(value) != true)) {
                        this.cROZBatchIdentifyingDatasField = value;
                        this.OnPropertyChanged("CROZBatchIdentifyingDatas");
                    }
                }
                else {
                    this.cROZBatchIdentifyingDatasField = value;
        ...
        public CROZParticipantsResponseOfficial Official {
            get {
    ...
    [System.SerializableAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true, Namespace="http://ereg.egov.bg/segment/R-1032")]
    public partial class CROZParticipantsResponseOfficial : InformationObject<CROZParticipantsResponseOfficial> {
