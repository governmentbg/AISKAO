define('babh/ForageCombinedSupplementOtherAnimalTradingData',
    ['ko', 'Utils',
    'GlobalParameters',
    'Enums',
    ...
    function (ko, Utils,
        ...
        var ForageCombinedSupplementOtherAnimalTradingData = function () {
            this._settings = {};
            this._settings.sectionTitle = 'Търговия на комбинирани фуражи, съдържащи странични животински продукти и/или производни продукти от категория 3, попадащи в обхвата на Регламент (ЕО) № 1069/2009';
            this._settings.xmlns = 'http://ereg.egov.bg/segment/R-1269';
        ...
        ForageCombinedSupplementOtherAnimalTradingData.prototype = function () {
        ...
        return ForageCombinedSupplementOtherAnimalTradingData;
