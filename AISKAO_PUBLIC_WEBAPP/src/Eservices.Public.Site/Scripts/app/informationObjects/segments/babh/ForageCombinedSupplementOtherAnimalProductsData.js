define('babh/ForageCombinedSupplementOtherAnimalProductsData',
    ['ko', 'Utils',
    'GlobalParameters',
    'Enums',
    ...
    function (ko, Utils,
        ...
        var ForageCombinedSupplementOtherAnimalProductsData = function () {
            this._settings = {};
            this._settings.sectionTitle = 'Производството на комбинирани фуражи, съдържащи странични животински продукти и/или производни продукти от категория 3, попадащи в обхвата на Регламент (ЕО) № 1069/2009';
            this._settings.xmlns = 'http://ereg.egov.bg/segment/R-1265';
        ...
        ForageCombinedSupplementOtherAnimalProductsData.prototype = function () {
        ...
        return ForageCombinedSupplementOtherAnimalProductsData;
